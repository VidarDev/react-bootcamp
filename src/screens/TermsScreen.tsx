      ...
      <ScrollView>
        <View style={styles.container}>
          <Text variant="bodyMedium">
            ...
            bottom of this document. Supplemental Terms and TOR Privacy Policy
            other Terms are an integral part of this Terms of Service and
            incorporated in this document by reference. You can find the Terms
          ...
          <Text variant="bodyMedium">
            ...
            or she takes full responsibility for all obligations under this of
            Service. TOR Accounts will not be allowed for minors under thirteen
            ...
            creation of a ["User Name" or "Persona"]. [User names or Personas]
            are tied to your Account. You may not use a ["User Name" or
            "Persona"] that is used by someone else, is vulgar or offensive, or
            otherwise violates the Terms of Service. You are solely responsible
            for all activity on your Account. Your Account may be terminated if
            someone else uses it to engage in activity that violates the Terms
            of Service or is otherwise improper or illegal. You should not
            reveal your Account password to others. BioWare and LucasArts will
            not ask you to reveal your password, or ever initiate any contact
            with you asking for your password reminder words.
          </Text>
