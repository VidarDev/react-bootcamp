...
export const Default = () => (
    <View style={{ padding: 16, justifyContent: "space-between", flex: 1 }}>
        ...
        <Button icon="camera" mode="outlined" onPress={() => console.log('Pressed')}>Press me</Button>
        <Button mode="outlined" onPress={() => console.log('Pressed')}>Press me</Button>
        <Button icon="camera" mode="text" onPress={() => console.log('Pressed')}>Press me</Button>
        <Button mode="text" onPress={() => console.log('Pressed')}>Press me</Button>
    </View>
);
